...
namespace Vartruexuan\EasyOutApi\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    protected function createSlackDriver(array $config)
    {
        return new Monolog($this->parseChannel($config), [
            $this->prepareHandler(new SlackWebhookHandler(
                $config['url'],
                $config['channel'] ?? null,
                $config['username'] ?? 'Vartruexuan\EasyOutApi',
    ...
    {
        return new Monolog('Vartruexuan\EasyOutApi', [new NullHandler()]);
    }
    ...
    {
        return $config['name'] ?? 'Vartruexuan\EasyOutApi';
    }
